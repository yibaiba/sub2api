...
func (*Proxy) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case proxy.FieldName, proxy.FieldProtocol, proxy.FieldHost, proxy.FieldUsername, proxy.FieldPassword, proxy.FieldBasePath, proxy.FieldStatus, proxy.FieldFallbackMode:
