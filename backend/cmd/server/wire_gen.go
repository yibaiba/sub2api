...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	imageStorageSettingService, err := service.ProvideImageStorageSettingService(settingRepository, secretEncryptor, backupService, imageStorageFactory, configConfig)
	if err != nil {
		return nil, err
	}
	...
	proxyHandler := handler.ProvideProxyHandler(adminService)
