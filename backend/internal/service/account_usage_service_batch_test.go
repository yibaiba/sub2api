...
func (r *usageBatchLogRepoStub) GetUsageTrendForAccounts(context.Context, []int64, time.Time, time.Time, string) ([]usagestats.TrendDataPoint, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GetModelStatsForAccounts(context.Context, []int64, time.Time, time.Time, string) ([]usagestats.ModelStat, error) {
	return nil, nil
}
