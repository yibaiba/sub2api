...
func TestOpenAIImageModelRejectsInputFidelity(t *testing.T) {
	require.True(t, openAIImageModelRejectsInputFidelity("gpt-image-2"))
	require.True(t, openAIImageModelRejectsInputFidelity("GPT-Image-2-codex"))
	require.True(t, openAIImageModelRejectsInputFidelity("gpt-image-2-2026-04-21"))
	require.False(t, openAIImageModelRejectsInputFidelity("gpt-image-2.5-flare"))
	require.False(t, openAIImageModelRejectsInputFidelity("gpt-image-2.5-sunburst"))
	require.False(t, openAIImageModelRejectsInputFidelity("gpt-image-1.5"))
}
