...
func TestOpenAIAccountScheduleModelUsesActualUpstreamModel(t *testing.T) {
	...
	require.Equal(t, "mapped-image-model", openAIAccountScheduleModel(nil, account, "gpt-image-1", false, nil))
	require.Equal(t, "actual-upstream-model", openAIAccountScheduleModel(nil, account, "gpt-image-1", false, &service.OpenAIForwardResult{
		UpstreamModel: "actual-upstream-model",
	}))
	require.Equal(t, "mapped-image-model", openAIAccountScheduleModel(nil, account, "gpt-image-1", false, &service.OpenAIForwardResult{}))
	require.Equal(t, "gpt-image-1", openAIAccountScheduleModel(nil, nil, " gpt-image-1 ", false, nil))
}
