...
export interface User {
  ...
  wecom_bound?: boolean
  role: 'admin' | 'user' | 'usage_viewer' // User role for authorization
  ...
  allowed_accounts?: number[] | null // Account IDs visible to usage_viewer users
...
export type ProxyProtocol = 'http' | 'https' | 'socks5' | 'socks5h' | 'resin_http' | 'resin_https' | 'resin_socks5'
