export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        cchSigning: 'CCH Signing (Deprecated)',
        cchSigningHint: 'Deprecated: newer Claude Code clients no longer send the cch field, so this setting no longer affects forwarded requests.',
